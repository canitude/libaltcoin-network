...
class BCT_API protocol_seed_31402
  : public protocol_timer<MessageSubscriber>, track<protocol_seed_31402<MessageSubscriber>>
{
public:
    typedef std::shared_ptr<protocol_seed_31402<MessageSubscriber>> ptr;
     ...
     */
    protocol_seed_31402(p2p<MessageSubscriber>& network, typename channel<MessageSubscriber>::ptr channel);
