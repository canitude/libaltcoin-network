...
class BCT_API protocol_version_70002
  : public protocol_version_31402<MessageSubscriber>, track<protocol_version_70002<MessageSubscriber>>
{
public:
    typedef std::shared_ptr<protocol_version_70002<MessageSubscriber>> ptr;
    typedef typename protocol_version_31402<MessageSubscriber>::event_handler event_handler;
     ...
     */
    protocol_version_70002(p2p<MessageSubscriber>& network, typename channel<MessageSubscriber>::ptr channel);
